...
«Нагадування», which opens the daily reminder and what the app announces, «Бекап», which
opens saving the whole state to one file and restoring it from one, and «Репорти про помилки»,
which opens the list of репорти and filing a new one.
...
- **THEN** the sections «Перші кроки», «Категорії», «Джерела», «Правила», «Ліміти», «Цілі»,
  «Імпорт Saldo», «monobank», «Сповіщення банків», «Нагадування», «Бекап» and «Репорти про
  помилки» are offered
...
#### Scenario: The reminders section opens the reminder and its time

- **WHEN** the owner opens «Нагадування»
- **THEN** the notification permission, the daily нагадування's switch and its time, and what the
  app announces are available in one flow
