...
«Нагадування», which opens the daily reminder and what the app announces, and «Бекап», which
opens saving the whole state to one file and restoring it from one.
...
- **THEN** the sections «Перші кроки», «Категорії», «Джерела», «Правила», «Ліміти», «Цілі»,
  «Імпорт Saldo», «monobank», «Сповіщення банків», «Нагадування» and «Бекап» are offered
